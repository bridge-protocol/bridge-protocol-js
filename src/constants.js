class Constants {
    constructor() {
        //Bridge Passport / Network
        this.passportVersion = 3.0;
        this.bridgeApiUrl = "https://localhost:5001/"; //"https://api.bridgeprotocol.io/";
        this.bridgeExplorerUrl = "https://explorer.bridgeprotocol.io/";
        ...
        return [
            {
                ...
                "infoUrl": "https://verification.bridgeprotocol.io"
            },
        ]
    }
