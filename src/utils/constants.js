class Constants {
    constructor() {
        this.bridgeApiUrl = "https://bridgeprotocol-site-webapp.azurewebsites.net/api/";
        this.bridgeExplorerUrl = "https://bridgeprotocol-site-webapp.azurewebsites.net/explorer/";
